									...
									<div class="variants__group">
										<div class="radio radio--active">
											<label class="radio__label">
												<input class="radio__input" type="radio" name="body" value="sedan" checked="checked">
												<img src="${car5}" width="45px" alt="car5">
										...
										<div class="radio ">
											<label class="radio__label">
												<input class="radio__input" type="radio" name="body" value="hatchback" disabled="disabled">
												<img src="${car3}" width="45px" alt="car3">
										...
										<div class="radio ">
											<label class="radio__label">
												<input class="radio__input" type="radio" name="body" value="hatchback" disabled="disabled">
												<img src="${car7}" width="45px" alt="car7">
										...
										<div class="radio">
											<label class="radio__label">
												<input class="radio__input" type="radio" name="body" value="hatchback" disabled="disabled">
												<img src="${car15}" width="45px" alt="car15">
										...
										<div class="radio">
											<label class="radio__label">
												<input class="radio__input" type="radio" name="body" value="hatchback" disabled="disabled">
												<img src="${car8}" width="45px" alt="car8">
